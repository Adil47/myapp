...
<table >
	<tr>
		<td><h2 style="color: orange">Welcome : <?php echo $_SESSION["Email"]?></h2></td>
		<td><img src="<?php echo $_SESSION['img'] ?>" height="50" width="50" style="border-radius: 25px; border:2px solid black;"></td>
	</tr>
</table>
	</center>
	<form action="login.php" method="post" style="width: 40px; margin-left: auto;margin-top:-50px;">
		<input type="hidden" name="logout" value="logout">
		<input type="image" src="Assets/images/logout.png" name="logout" width="40">
